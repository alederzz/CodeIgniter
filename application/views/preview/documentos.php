...
contexto.fillText("<?php echo $cliente->razon_social; ?>",125,230);
contexto.fillText("<?php echo $cliente->nro_documento; ?>",660,230);
contexto.fillText("<?php echo $cliente->direccion; ?>",125,260);
