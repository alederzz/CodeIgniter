                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg pull-right">
                            <div class="listview" id="notifications">
                                ...
                                <a class="lv-footer" href="">Ver Antiguas</a>
                            </div>
                        </div>
                    ...
                    <div class="si-inner">
                        <div class="profile-menu">
                            ...
                            <ul class="main-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url("home/logout")?>"><i class="md md-history"></i> Logout</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="friends">
                        <div class="listview">
                            ...
                            <a class="lv-item" href="">
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="lv-img-sm" src="<?php echo base_url();?>img/profile-pics/5.jpg" alt="">
                                    </div>
                                    <div class="media-body">
                                        <div class="lv-title">Bill Phillips</div>
                            ...
                            <a class="lv-item" href="">
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="lv-img-sm" src="<?php echo base_url();?>img/profile-pics/6.jpg" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="lv-item" href="">
                                <div class="media">
                                    <div class="pull-left p-relative">
                                        <img class="lv-img-sm" src="<?php echo base_url();?>img/profile-pics/7.jpg" alt="">
                                        <i class="chat-status-busy"></i>
                                    </div>
                                    <div class="media-body">
